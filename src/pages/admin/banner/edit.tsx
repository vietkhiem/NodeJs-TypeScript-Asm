...
import { readbanner } from '../../../api/banner'
import { BannerType } from '../../../types/banner'


type ProducAddProps = {

    onUpdate: (banner: BannerType) => void
}
type FromInput = {
    img: string
                            ...
                            <div className="lg:flex lg:items-center lg:justify-between">
                                ...
                                <div className="mt-5 flex lg:mt-0 lg:ml-4">
                                    <span className="sm:ml-3">
                                        <NavLink to="/admin/banner" className="no-underline" >
