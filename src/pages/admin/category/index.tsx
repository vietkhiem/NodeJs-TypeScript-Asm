                                                        ...
                                                        {props.categorys?.map((category, index) => {
                                                            ...
                                                            return (
                                                                <tr key={index} className="border-bottom text-[20px]">
                                                                    ...
                                                                    <td colSpan={2} >    <Link to={`/admin/category/${category._id}/edit`} className="btn btn-primary">Update</Link>
                                                                        <button onClick={() => props.onRemove(category._id)} className="btn btn-danger">Remove</button>
