                                                ...
                                                <table className="table table-borderless table-responsive card-1 p-4">
                                                    <thead>
                                                        <tr className="border-bottom">
                                                            ...
                                                            <th> <span className="ml-2">Password</span> </th>
                                                        ...
                                                        {props.users?.map((user, index) => {
                                                            ...
                                                            return (
                                                                <tr key={index} className="border-bottom text-[20px]">
                                                                    ...
                                                                    <td colSpan={2} >    <Link to={`/admin/user/${user._id}/edit`} className="btn btn-primary">Update</Link>
                                                                        <button onClick={() => props.onRemove(user._id)} className="btn btn-danger">Remove</button>
                                                                    </td>
                                                                </tr>
                                                            )
                                                        })}
